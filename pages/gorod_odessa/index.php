...
<body>
	...
	<div id="wrapper">
		<div id="staff" class="container">
			<div class="title">
				<h2>
					«Эксимнефтепродукт», «Одессанефтепродукт», г. Одесса
				</h2>
				<div class="galleria">
					<img src="1.jpg">
					<img src="2.jpg">
			...
			<p>13 резервуаров с темными и светлыми нефтепродуктами разной вместимости, на каждом резервуаре установлен
				датчик ИПЖ с термоподвеской.</p>
		</div>
	</div>
